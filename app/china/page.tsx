...
export default function ChinaLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-slate-900 font-sans selection:bg-[#8B0000]/30 scroll-smooth">
      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-xl z-50 border-b border-gray-100 transition-all shadow-sm">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 group cursor-pointer" onClick={() => window.scrollTo(0,0)}>
            <div className="w-12 h-12 bg-[#8B0000] rounded-2xl flex items-center justify-center text-white shadow-xl shadow-red-900/20 group-hover:scale-105 transition-transform">
              <span className="text-2xl">🇨🇳</span>
            </div>
            <div className="flex flex-col text-left">
              <span className="text-2xl font-black text-[#8B0000] leading-none uppercase tracking-tighter italic">EPM</span>
              <span className="text-xs font-bold text-[#EAB308] uppercase tracking-[0.35em]">China</span>
            </div>
          </div>

          <div className="hidden md:flex gap-12 text-xs font-black uppercase tracking-widest text-slate-400 items-center">
            <a href="/" className="hover:text-[#8B0000] hover:scale-105 transition-all">← Volver al Hub</a>
            <a href="#servicios" className="hover:text-[#8B0000] hover:scale-105 transition-all">Servicios</a>
            <a href="#testimonios" className="hover:text-[#8B0000] hover:scale-105 transition-all">Testimonios</a>
            <a href="#seguimiento" className="bg-[#8B0000] text-white px-8 py-4 rounded-full hover:bg-[#EAB308] hover:text-[#8B0000] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              Seguimiento
            </a>
          </div>

          <button className="md:hidden text-[#8B0000] p-2" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            <Menu size={32} />
          </button>
        </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-gray-100 p-6 flex flex-col gap-6 shadow-xl animate-fade-in">
            <a href="/" onClick={() => setMobileMenuOpen(false)} className="text-[#8B0000] font-bold text-lg">← Volver al Hub</a>
            <a href="#servicios" onClick={() => setMobileMenuOpen(false)} className="text-[#8B0000] font-bold text-lg">Servicios</a>
            <a href="#testimonios" onClick={() => setMobileMenuOpen(false)} className="text-[#8B0000] font-bold text-lg">Testimonios</a>
      ...
      <section id="inicio" className="pt-48 pb-32 px-6 flex flex-col items-center text-center max-w-6xl mx-auto min-h-screen justify-center">
        <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-red-50 border border-red-100 mb-10 animate-fade-in shadow-sm">
          <span className="w-2.5 h-2.5 rounded-full bg-[#8B0000] animate-pulse"></span>
          <span className="text-[#8B0000] text-xs font-black uppercase tracking-widest">Líderes en Consultoría Educativa</span>
        </div>
        
        <h1 className="text-5xl md:text-8xl lg:text-9xl font-black text-[#8B0000] mb-10 leading-[0.95] tracking-tight">
        ...
        <p className="text-slate-500 text-lg md:text-2xl max-w-3xl mx-auto font-medium leading-relaxed italic mb-14">
          Hacemos realidad tu sueño de estudiar en Asia. <br className="hidden md:block"/>
          Gestión de Visas X1, Becas CSC y programas MBBS.
        </p>
        
        <div className="flex flex-col md:flex-row gap-5 w-full md:w-auto px-4">
          <a href="#servicios" className="bg-[#8B0000] text-white px-10 py-5 md:px-12 md:py-6 rounded-full font-bold hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-red-900/30 uppercase text-xs md:text-sm tracking-widest flex items-center justify-center gap-3">
            Ver Servicios <ArrowRight size={18} />
          </a>
          <a 
            href="https://wa.me/593994287462?text=Hola%20EPM%20Agency,%20me%20interesa%20recibir%20m%C3%A1s%20informaci%C3%B3n%20sobre%20China."
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white text-[#8B0000] border-2 border-slate-100 px-10 py-5 md:px-12 md:py-6 rounded-full font-bold hover:border-[#8B0000] hover:bg-slate-50 transition-all uppercase text-xs md:text-sm tracking-widest flex items-center justify-center gap-2"
          >
      ...
      <section id="servicios" className="py-24 md:py-32 bg-slate-50/80 rounded-[3rem] md:rounded-[5rem] mx-4 md:mx-10 mb-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-6xl font-black text-[#8B0000] mb-6">Nuestros Servicios</h2>
            <div className="w-24 h-2 bg-[#EAB308] mx-auto rounded-full"></div>
            <p className="mt-6 text-slate-500 text-lg max-w-3xl mx-auto">
              Te acompañamos en todo el proceso de admisión, aplicación a becas gubernamentales e instalación en las mejores universidades de China.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <ServiceCard 
              ...
              title="Grado y Medicina (MBBS)"
              description="Asegura tu ingreso a programas de Medicina impartidos 100% en inglés (MBBS) en universidades reconocidas por la OMS. Te asesoramos con la admisión, el formulario JW202 y el trámite de tu Visa de Estudiante X1."
              whatsappMessage="Hola EPM, me interesa estudiar un Grado o Medicina (MBBS) en China."
            />
            
            {/* SERVICIO 2 - DESTACADO */}
            <div className="relative transform md:-translate-y-4">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-[#EAB308] text-[#8B0000] text-[10px] font-black uppercase tracking-widest px-6 py-2 rounded-full z-10 shadow-lg whitespace-nowrap">
                Más Solicitado
              </div>
              <ServiceCard 
                icon={<Stethoscope size={40} />}
                title="Especialidades y Pasantías"
                description="Asesoría para médicos y profesionales de la salud que buscan realizar especializaciones médicas o fellowships en hospitales de alta tecnología afiliados a las universidades más prestigiosas de China."
                highlighted={true}
                whatsappMessage="Hola EPM, soy profesional de la salud y busco información sobre Especialidades en China."
              />
            </div>
            ...
            <ServiceCard 
              ...
              title="Maestrías y Becas CSC"
              description="Potencia tu carrera con Maestrías y Doctorados en inglés o mandarín. Te guiamos paso a paso en la postulación a las becas del Gobierno Chino (CSC Scholarship) que cubren matrícula, alojamiento y estipendio mensual."
              whatsappMessage="Hola EPM, busco información sobre Maestrías y Becas CSC en China."
            />
          </div>
        </div>
      </section>
      ...
      <section id="testimonios" className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[#8B0000]">Ellos confiaron en EPM China</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <TestimonialCard 
            name="Dr. Carlos Mendoza" 
            role="Estudiante MBBS"
            text="Ir a estudiar Medicina a China parecía un sueño inalcanzable. EPM me ayudó con la admisión directa para estudiar en inglés y con todo el proceso de mi Visa X1."
          />
          <TestimonialCard 
            name="Lic. Elena Suárez" 
            role="Maestría con Beca CSC"
            text="La documentación para postular a la beca del gobierno chino es compleja, pero el equipo armó mi expediente perfecto. Hoy estudio en Shanghái con todo cubierto."
          />
          <TestimonialCard 
            name="Dra. Valentina Ortiz" 
            role="Fellowship en Cirugía"
            text="La agencia me conectó con programas de especialización médica de altísima tecnología en Beijing. La legalización de mi título fue rápida y sin contratiempos."
          />
        </div>
      </section>
      ...
      <section id="seguimiento" className="py-24 md:py-32 px-4 md:px-6">
        <div className="max-w-5xl mx-auto bg-white rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-16 border border-slate-100 shadow-[0_40px_80px_-20px_rgba(139,0,0,0.15)] relative overflow-hidden">
          
          <div className="absolute top-0 right-0 w-96 h-96 bg-red-50/50 rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/3"></div>
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-[#8B0000]">Estado de tu Trámite</h2>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-16 bg-white p-3 rounded-[2rem] border border-gray-100 shadow-xl max-w-3xl mx-auto">
            <input 
              ...
              className="flex-1 px-8 py-4 bg-transparent outline-none text-lg font-semibold text-[#8B0000] placeholder:text-slate-300 w-full"
              onChange={(e) => setQuery(e.target.value)}
              onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
            />
            <button 
              onClick={handleSearch} 
              className="bg-[#8B0000] text-white px-10 py-4 rounded-[1.5rem] font-bold hover:bg-[#EAB308] hover:text-[#8B0000] transition-colors uppercase text-xs tracking-widest w-full md:w-auto shadow-lg flex items-center justify-center gap-2"
            >
            ...
            <div className="animate-fade-in space-y-10">
              <div className="flex flex-col md:flex-row justify-between items-end border-b-2 border-slate-50 pb-8 gap-6">
                <div className="text-left w-full">
                  ...
                  <h3 className="text-2xl md:text-4xl font-black text-[#8B0000] uppercase italic tracking-tight">{result.nombre}</h3>
                </div>
                <div className="bg-red-50 px-6 py-4 rounded-2xl w-full md:w-auto text-center md:text-right">
                  <span className="text-[#8B0000] font-bold text-sm block md:inline mr-2">Progreso: </span>
                  <span className="text-[#8B0000] font-black text-3xl">{result.progreso}%</span>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <StatusCard label="Admisión / JW202" value={result.dni} />
                <StatusCard label="Beca / Visa X1" value={result.convalidacion} />
              ...
              {(result.documentacion?.toLowerCase().includes("incompleta") || result.documentacion?.toLowerCase().includes("revisión") || result.documentacion?.toLowerCase().includes("revision")) && (
                <div className="bg-[#EAB308]/10 border-2 border-dashed border-[#EAB308]/40 rounded-[2rem] p-8 text-center relative animate-fade-in mt-6">
                    <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <h4 className="text-[#8B0000] font-black text-lg">Acción Requerida: Sube tus documentos</h4>
                        ...
                        <button onClick={() => fileInputRef.current?.click()} disabled={uploading} className="bg-[#8B0000] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#EAB308] hover:text-[#8B0000] transition-all text-xs uppercase tracking-widest flex items-center gap-2 shadow-lg">
              ...
              <div className="bg-[#8B0000] p-10 rounded-[2.5rem] text-white relative overflow-hidden group text-left shadow-2xl">
          ...
          {error && (
            <div className="flex flex-col items-center justify-center py-10 text-center animate-fade-in">
              ...
              <h3 className="text-xl font-bold text-[#8B0000] mb-2">Documento no encontrado</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-[#8B0000] rounded-2xl flex items-center justify-center text-white shadow-lg"><Globe size={24} /></div>
                <div className="flex flex-col text-left">
                  <span className="text-2xl font-black text-[#8B0000] leading-none uppercase tracking-tighter italic">EPM</span>
              ...
              <p className="text-slate-500 text-sm font-medium max-w-xs leading-relaxed">
                Especialistas en gestión académica, legal y migratoria para estudiantes y profesionales de la salud con destino a China.
              </p>
            </div>

            {/* 2. Líneas de Atención (Banderas) */}
            <div className="flex flex-col items-center md:items-start">
              <h4 className="text-[#8B0000] font-black uppercase tracking-widest text-xs mb-6">Líneas de Atención</h4>
            ...
            <div className="flex flex-col items-center md:items-start">
              <h4 className="text-[#8B0000] font-black uppercase tracking-widest text-xs mb-6">Correos Corporativos</h4>
              <div className="space-y-3">
                <a href="mailto:info@estudiosporelmundo.com" className="flex items-center gap-3 text-slate-600 hover:text-[#EAB308] transition-colors font-bold text-sm group">
                  <div className="bg-red-50 p-2.5 rounded-xl text-red-700 group-hover:bg-red-100 transition-colors"><Mail size={16}/></div>
      ...
      {/* --- WHATSAPP FLOTANTE --- */}
      <a 
        href="https://wa.me/593994287462?text=Hola%20EPM%20Agency,%20necesito%20asesor%C3%ADa%20para%20China." 
        target="_blank" 
        rel="noopener noreferrer"
...
function ServiceCard({ icon, title, description, highlighted = false, whatsappMessage }: any) {
  const finalMessage = whatsappMessage || "Hola EPM, quiero más información sobre China.";
  const link = `https://wa.me/593994287462?text=${encodeURIComponent(finalMessage)}`;

  return (
    <div className={`h-full p-8 md:p-10 rounded-[2.5rem] border transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center group ${highlighted ? 'bg-[#8B0000] text-white border-[#8B0000] shadow-2xl shadow-red-900/20' : 'bg-white border-gray-100 text-[#8B0000] hover:shadow-xl hover:border-[#EAB308]/30'}`}>
      <div className={`mb-8 p-5 rounded-3xl transition-colors ${highlighted ? 'bg-white/10 text-[#EAB308]' : 'bg-[#8B0000]/5 text-[#8B0000] group-hover:bg-[#EAB308] group-hover:text-[#8B0000]'}`}>
        {icon}
      </div>
      ...
      <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        className={`px-8 py-3 rounded-xl font-bold uppercase text-[10px] tracking-widest transition-all shadow-lg hover:scale-105 flex items-center gap-2 mt-auto ${highlighted ? 'bg-[#EAB308] text-[#8B0000] hover:bg-white' : 'bg-[#8B0000] text-white hover:bg-[#EAB308] hover:text-[#8B0000]'}`}
      >
  ...
  return (
    <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 relative">
      ...
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 bg-slate-100 rounded-full flex items-center justify-center text-xl font-black text-[#8B0000]">
          {name.charAt(0)}
        </div>
        <div>
          <h4 className="font-bold text-[#8B0000]">{name}</h4>
